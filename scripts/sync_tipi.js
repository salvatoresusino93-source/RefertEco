...
const TIPI = [
  ...
  { nome: 'Ecografia addome superiore',                        durata_minuti: 30, codice_dicom: 'US_ADD_SUP' },
  { nome: 'Ecografia addome inferiore',                        durata_minuti: 30, codice_dicom: 'US_ADD_INF' },
  ...
  { nome: 'Ecografia muscolo-scheletrica',                     durata_minuti: 30, codice_dicom: 'US_MSK' },
  { nome: 'Ecografia spalla',                                  durata_minuti: 30, codice_dicom: 'US_SPALLA' },
  { nome: 'Ecografia ginocchio',                               durata_minuti: 30, codice_dicom: 'US_GINOCCHIO' },
  { nome: 'Ecografia anca',                                    durata_minuti: 30, codice_dicom: 'US_ANCA' },
  { nome: 'Ecografia anca neonatale',                          durata_minuti: 30, codice_dicom: 'US_ANCA_NEO' },
  { nome: 'Ecografia gomito',                                  durata_minuti: 30, codice_dicom: 'US_GOMITO' },
  { nome: 'Ecografia polso e mano',                            durata_minuti: 30, codice_dicom: 'US_POLSO' },
  { nome: 'Ecografia caviglia e piede',                        durata_minuti: 30, codice_dicom: 'US_CAVIGLIA' },
  { nome: 'Ecografia parti molli',                             durata_minuti: 30, codice_dicom: 'US_PARTI_MOLLI' },
  { nome: 'Ecocolordoppler TSA (tronchi sovra-aortici)',       durata_minuti: 30, codice_dicom: 'DOPPLER_TSA' },
  { nome: 'Ecocolordoppler aorta addominale',                  durata_minuti: 30, codice_dicom: 'DOPPLER_AORTA' },
  ...
  { nome: 'Ecografia linfonodi',                               durata_minuti: 30, codice_dicom: 'US_LINFONODI' },
];
